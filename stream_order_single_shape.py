...
print 'First flow direction deleted'; arcpy.Delete_management(flowdir);
print 'Min sink layer deleted'; arcpy.Delete_management(min_h);
print 'Max sink layer deleted'; arcpy.Delete_management(max_h);
print 'Sink depth deleted'; arcpy.Delete_management(sink_depth);
print 'Streams delineated from flow accumulation deleted'; arcpy.Delete_management(streams);
print 'Clipped out area deleted'; arcpy.Delete_management(new);
print 'Output_drop_raster deleted'; arcpy.Delete_management(Output_drop_raster);
################################################################################
print ""
